<template>
  <div>
    ...
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('guest.index')">
        <icon name="users" class="w-4 h-4 mr-2" :class="isUrl('guest.index') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('guest.index') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Daftar Tamu</div>
      </inertia-link>
    </div>
<!--    <div class="mb-4">-->
